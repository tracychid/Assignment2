...
EPI 203, Spring 2026 Assignment 2. This project involves analyzing a synthetic dataset with any prediction model.
...
# Save as PNG
## looks like you've got two Assignment2_DataAnalysis_files! I'm assuming the one within data-analysis is the right one?
...
```{r}
## consider adding all library imports at the beginning of the script rather within each code chunk
library(ggplot2)
